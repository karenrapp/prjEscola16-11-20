                ...
                <fieldset>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-6">
                            ...
                            <asp:DropDownList ID="cboCurso"  CssClass="form-control" runat="server" ></asp:DropDownList>
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                       ...
                       <asp:GridView ID="grvTurma" runat="server" AutoGenerateColumns="False" OnRowCommand="grvTurma_RowCommand" >
                            <Columns>
                                <asp:TemplateField HeaderText="Código" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lblIdTurma" runat="server" 
                                            CommandArgument= '<%#Eval("ID_TURMA").ToString()%>' 
                                            Text='<%#Eval("ID_TURMA").ToString()%>' OnSelectedIndexChanging="grvTurma_SelectedIndexChanged" OnClientClick="grvTurma_SelectedIndexChanged">
                                        </asp:LinkButton>
                                ...
                                <asp:BoundField DataField="DATA_TERMINO" HeaderText="Término" />
