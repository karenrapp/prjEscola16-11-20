<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="cAluno.aspx.cs" Inherits="prjEscola.cAluno" %>
                ...
                <fieldset>
                    ...
                    <div>
                        <asp:DataGrid ID="dgAlunos" runat="server" AutoGenerateColumns="False"
                            ...
                            Width="80%" AllowPaging="True" TabIndex="1" OnSelectedIndexChanged="dgAlunos_SelectedIndexChanged">
