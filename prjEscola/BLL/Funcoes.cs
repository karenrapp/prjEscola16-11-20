...
namespace prjEscola.BLL
{
    ...
    {
        //1204-15-057233\\SQLSERVER

        private static string _connString = "Initial Catalog=BDESCOLA;Data Source=DESKTOP-BO9PQ81\\SQLEXPRESS;user id=bdusuario;password=senha;";
